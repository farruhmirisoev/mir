  ...
  <div class="content"<?php print $content_attributes; ?>>
    ...
    <?php 
      ...
      if(isset($nodes[($node->nid)-1])): ?>
        <div class="mir-nav-button mir-nav-button--left"><a href="/node/<?php print ($node->nid)-1; ?>"><?php print t('Предыдущая работа'); ?></a></div>
      <?php endif; 
      
      //check if the next node id isset and put the link
      if(isset($nodes[($node->nid)+1])): ?>
        <div class="mir-nav-button mir-nav-button--right"><a href="/node/<?php print ($node->nid)+1; ?>"><?php print t('Cледующая работа'); ?></a></div>
      <?php endif; ?>
